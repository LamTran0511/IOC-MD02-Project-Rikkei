            ...
            try {
                switch (ch) {
                    ...
                    case 5: {
                        ...
                        TablePrinter.courses(courseService.searchCourse(keyword));
                        Input.pause();
                        break;
                    }
            ...
            try {
                switch (ch) {
                    ...
                    case 3: {
                        ...
                        switch (f) {
                            case 1:
                                studentService.updateField(id, "name", Input.nonBlank("Tên mới: "));
                                break;
                            case 2:
                                studentService.updateField(id, "dob",
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                studentService.updateField(id, "sex",
                                        Input.readInt("Giới tính mới (Nam=1, Nữ=0): ", 0, 1) == 1);
                                break;
                            case 5:
                                studentService.updateField(id, "phone",
