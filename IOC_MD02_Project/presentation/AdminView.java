...
public class AdminView {
    ...
    private static void menu(Admin a) {
        while (true) {
            ...
            System.out.println("Xin chào, " + a.getUsername());
            ...
            try {
                switch (ch) {
                    ...
                    case 3: {
                        ...
                        switch (f) {
                            case 1:
                                courseService.updateField(id, "name", Input.nonBlank("Tên mới: "));
                                break;
                            case 2:
                                courseService.updateField(id, "duration",
                                        Input.readInt("Thời lượng mới: ", 1, Integer.MAX_VALUE));
                                break;
                            case 3:
                                courseService.updateField(id, "instructor", Input.nonBlank("Giảng viên mới: "));
                                break;
                            default:
                                break;
                        }
    ...
    private static void studentMenu() {
        while (true) {
            ...
            try {
                switch (ch) {
                    case 1:
                        TablePrinter.students(studentService.list("id", "ASC"));
                        Input.pause();
                        break;

                    case 2: {
                        String name = Input.nonBlank("Họ tên: ");
                        Date dob = Date.valueOf(Input.inputDate("DOB (yyyy-mm-dd): "));
                    ...
                    case 3: {
                        ...
                        switch (f) {
                            case 1:
                                check = studentService.updateField(id, "name", Input.nonBlank("Tên mới: "));
                                break;
                            case 2:
                                check = studentService.updateField(id, "dob",
                                        Date.valueOf(Input.nonBlank("DOB mới (yyyy-mm-dd): ")));
                                break;
                            case 3:
                                check = studentService.updateField(id, "email", Input.nonBlank("Email mới: "));
                                break;
                            case 4:
                                check = studentService.updateField(id, "sex",
                                        Input.readInt("Giới tính mới (Nam=1, Nữ=0): ", 0, 1) == 1);
                                break;
                            case 5:
                                check = studentService.updateField(id, "phone",
                                        Input.optional("SĐT mới (có thể bỏ trống): "));
                                break;
                            default:
                                break;
                        }
                    ...
                    case 5: {
                        String keyword = Input.nonBlank("Nhập từ khóa tìm kiếm: ");
                        TablePrinter.students(studentService.searchStudent(keyword));
                        Input.pause();
                        break;
                    }
                    ...
                    case 6: {
                        ...
                        TablePrinter.students(studentService.list(by, dir));
                        Input.pause();
                        break;
                    }
