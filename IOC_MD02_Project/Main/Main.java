package IOC_MD02_Project.Main;

import IOC_MD02_Project.dao.Admindao;
import IOC_MD02_Project.dao.Coursedao;
import IOC_MD02_Project.dao.Enrollmentdao;
import IOC_MD02_Project.dao.Studentdao;
                ...
                switch (ch) {
                    ...
                    case 3 -> {
                        ...
                        switch (f) {
                            ...
                            case 5 ->
                                    studentDao.updateField(id, "phone", Input.optional("Phone mới (có thể bỏ trống): "));
                        }
