...
public class Main {
    ...
    static final IAdminService adminService = new AdminServiceImpl();
    static final ICourseService courseService = new CourseServiceImpl();
    static final IStudentService studentService = new StudentServiceImpl();
    static final IEnrollmentService enrollmentService = new EnrollmentServiceImpl();
            ...
            try {
                switch (ch) {
                    ...
                    case 3: {
                        ...
                        if (f == 1) {
                            courseService.updateField(id, "name", Input.nonBlank("Name mới: "));
                        } else if (f == 2) {
                            courseService.updateField(id, "duration",
                                    Input.readInt("Duration mới: ", 1, Integer.MAX_VALUE));
                        } else {
                            courseService.updateField(id, "instructor", Input.nonBlank("Instructor mới: "));
                        }
                        ...
                        switch (f) {
                            ...
                            case 5:
                                studentService.updateField(id, "phone",
                                        Input.optional("Phone mới (có thể bỏ trống): "));
                                break;
                            default:
                                break;
                        }
